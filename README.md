...
```console
kubectl apply --force-conflicts --server-side -k github.com/k8ssandra/cass-operator/config/deployments/default?ref=v1.18.2
```
...
```console
kubectl apply --force-conflicts --server-side -k github.com/k8ssandra/cass-operator/config/deployments/cluster?ref=v1.18.2
```
...
```console
kubectl apply -k github.com/k8ssandra/cass-operator/config/prometheus?ref=v1.18.2
```
...
components:
  - github.com/k8ssandra/cass-operator/config/components/cluster?ref=v1.18.2
```
...
```
kubectl apply -f https://raw.githubusercontent.com/k8ssandra/cass-operator/v1.18.2/operator/k8s-flavors/gke/storage.yaml
```
...
```console
kubectl -n cass-operator apply -f https://raw.github.com/k8ssandra/cass-operator/blob/master/config/samples/example-cassdc-three-nodes-single-rack.yaml
```
