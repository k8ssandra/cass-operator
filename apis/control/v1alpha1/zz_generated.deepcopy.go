...
func (in *CassandraTaskStatus) DeepCopyInto(out *CassandraTaskStatus) {
	*out = *in
	...
	if in.PodStatuses != nil {
		...
		*out = make(map[string]PodProcessingStatus, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodProcessingStatus) DeepCopyInto(out *PodProcessingStatus) {
	*out = *in
	if in.StartTime != nil {
		in, out := &in.StartTime, &out.StartTime
		*out = (*in).DeepCopy()
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodProcessingStatus.
func (in *PodProcessingStatus) DeepCopy() *PodProcessingStatus {
	if in == nil {
		return nil
	}
	out := new(PodProcessingStatus)
	in.DeepCopyInto(out)
	return out
}
