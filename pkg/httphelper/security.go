...
func (provider *ManualManagementApiSecurityProvider) AddServerSecurity(pod *corev1.PodTemplateSpec) error {
	...
	container.LivenessProbe.Handler.Exec = provider.BuildMgmtApiWgetAction(LivenessEndpoint, livenessTimeout)
	...
	container.ReadinessProbe.Handler.Exec = provider.BuildMgmtApiWgetAction(ReadinessEndpoint, readinessTimeout)
