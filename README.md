...
```console
kubectl apply --force-conflicts --server-side -k github.com/k8ssandra/cass-operator/config/deployments/default?ref=v1.16.0
```
...
```console
kubectl apply --force-conflicts --server-side -k github.com/k8ssandra/cass-operator/config/deployments/cluster?ref=v1.16.0
```
...
```console
kubectl apply -k github.com/k8ssandra/cass-operator/config/prometheus?ref=v1.16.0
```
...
components:
  - github.com/k8ssandra/cass-operator/config/components/cluster?ref=v1.16.0
```
...
```
kubectl apply -f https://raw.githubusercontent.com/k8ssandra/cass-operator/v1.16.0/operator/k8s-flavors/gke/storage.yaml
```
...
<img referrerpolicy="no-referrer-when-downgrade" src="https://static.scarf.sh/a.png?x-pxid=c7215522-51fa-48e7-a920-59eba0362c72" />
