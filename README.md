...
```console
kubectl apply -k github.com/k8ssandra/cass-operator/config/prometheus?ref=v1.10.3
```
...
resources:
  - github.com/k8ssandra/cass-operator/config/deployments/default?ref=v1.10.3

components:
  - github.com/k8ssandra/cass-operator/config/components/cluster?ref=v1.10.3
```
...
```
kubectl apply -f https://raw.githubusercontent.com/k8ssandra/cass-operator/v1.10.3/operator/k8s-flavors/gke/storage.yaml
```
