...
//+kubebuilder:rbac:groups=scheduledtask.k8ssandra.io,resources=scheduledtask,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=scheduledtask.k8ssandra.io,resources=scheduledtask/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=scheduledtask.k8ssandra.io,resources=scheduledtask/finalizers,verbs=update
