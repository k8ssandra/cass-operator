...
const (
	...
	UpdatingVolumeAttributesClass     string = "UpdatingVolumeAttributesClass"
	ModifyVolumeAttributesInProgress  string = "ModifyVolumeAttributesInProgress"
	VolumeAttributesClassUpdated      string = "VolumeAttributesClassUpdated"
